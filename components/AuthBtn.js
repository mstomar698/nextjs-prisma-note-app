...
const AuthBtn = () => {
  ...
  return (
    <div className="auth-btn border-solid border-2 border-green-500 flex items-center">
      <div className="auth-info flex justify-between space-x-4 items-center pr-2">
        <Image
